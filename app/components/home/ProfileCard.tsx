...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
    ...
    const getOffsets = (evt: MouseEvent | React.MouseEvent, el: HTMLElement) => {
    ...
    useEffect(() => {
        ...
        const pointerEnterHandler = (e: PointerEvent) => handlePointerEnter(e);
    ...
    const cardStyle = useMemo(
        () => ({
            ...
            '--sunpillar-clr-2': 'var(--sunpillr-2)',
            '--sunpillar-clr-3': 'var(--sunpllar-3)',
            '--sunpillar-clr-4': 'var(--sunillar-4)',
            '--sunpillar-clr-5': 'var(--sunpilar5)',
            '--sunpillar-clr-6': 'var(--sunpilar-6)'
